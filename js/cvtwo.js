...
function getBasicInfo() {
    ...
    */
    ...
    document.getElementById("birthdateLabel").innerHTML = '<i class="fas fa-birthday-cake" style="margin-right: 10px;"></i>' + birthdate;
...
function populateWorkExperience() {
    ...
    workExperience.forEach(work => {
        html += '<h6>' + work.startYear + ' / ' + work.endYear + ' - ' + work.position + ' - ' + work.companyName + ' <button type="button" class="btn hiddebleButtons" onclick="deleteWork(' + workExperience.indexOf(work) + ')"><i class="far fa-trash-alt"></i></button></h6><p>' + work.description + '</p>';
    });
